  ...
  return (
    <div className="w-full flex justify-end items-center pr-0">
      <div className="max-w-4xl text-white mix-blend-difference text-right">
        {/* Кнопка действия, выровненная по правому краю без дополнительных отступов */}
        ...
        {/* Заголовки: убрано pr-4 и добавлено overflow-visible для курсива, чтобы край букв совпадал с краем навигации */}
        <div className="relative overflow-visible">
           <h1 className="text-6xl md:text-8xl lg:text-9xl font-extralight leading-[0.8] mb-4 tracking-tighter">
            UI/UX
          </h1>
        </div>
        
        <div className="relative overflow-visible">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-light leading-[1.1] opacity-80 tracking-tighter italic block">
            Designer & Analyst
          </h2>
        </div>
